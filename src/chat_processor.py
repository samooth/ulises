        ...
        *anything* that changes turn-to-turn — timestamps, retrieved snippets,
        ...
        if use_web:
            try:
                ...
                # Defensive cleanup: strip residual fenced/inline markdown from
                # the final query so neither the generated nor fallback query
                # leaks fences/backticks into the search call.
