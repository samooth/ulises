...
const SMOOTH_KEY = 'ulises.signature.smoothness';
  ...
  return new Promise((resolve) => {
    ...
    const overlay = _modal(`
      <div class="modal-content" style="width:min(560px,94vw);">
        ...
        <div class="modal-footer" style="display:flex;gap:8px;justify-content:flex-end;padding-top:8px;border-top:1px solid var(--border);margin-top:6px;">
          <button class="sig-clear confirm-btn confirm-btn-secondary">${t('common.clear')}</button>
          <button class="sig-undo confirm-btn confirm-btn-secondary">${t('common.undo')}</button>
    ...
    saveBtn.onclick = async () => {
      ...
      try {
        ...
        alert(t('signature.save_failed', { msg: e.message }));
