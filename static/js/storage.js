...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'ulises-model-expanded',
  MODEL_ENDPOINTS: 'ulises-model-endpoints',
  MODEL_SELECTED: 'ulises-selected-model',
  SORT_ORDER: 'ulises-sessions-sort',
  CHAT_SEARCH_SCOPE: 'ulises-search-scope',
  INCOGNITO: 'ulises-incognito',
  RAG_ACTIVE: 'ulises-rag-active',
  MCP_ACTIVE: 'ulises-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'ulises-density',
  WORKSPACE: 'ulises-workspace'
};
