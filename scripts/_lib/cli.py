"""scripts/_lib/cli.py — shared scaffolding for the `ulises-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("ulises-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/ulises-foo`
...
VERSION = "0.1.0"  # bumped centrally; every ulises-* CLI reports this
