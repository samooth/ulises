...
```text
[order-report] working directory: /path/to/ulises
...
[order-report] reproduce with: /path/to/ulises/venv/bin/python /path/to/ulises/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
